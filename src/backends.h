...
typedef struct RAI_LoadedBackend {
  RAI_Model* (*model_create_with_nodes)(RAI_Backend, RAI_Device, int64_t, const char*,
                                        size_t, const char**, size_t, const char**,
                                        const char*, size_t, RAI_Error*);
  RAI_Model* (*model_create)(RAI_Backend, RAI_Device, int64_t, const char*,
                             const char*, size_t, RAI_Error*);
  ...
  RAI_Script* (*script_create)(RAI_Device, int64_t, const char*, const char*, RAI_Error*);
