...
![RedisAI Data Structures and Backends](images/RedisAI_data_structures_and_backends.png "RedisAI Data Structures and Backends")
TBD: diagram needs to be simplified and updated to include TensorFlow Lite.
